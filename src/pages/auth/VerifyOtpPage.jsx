    ...
    <div className="min-h-screen flex font-sans" style={{ fontFamily: "'Inter', 'Plus Jakarta Sans', sans-serif" }}>
      ...
      >
        ...
        <div className="relative z-10 px-12 flex-1 flex flex-col justify-center">
          ...
          <h1 className="text-4xl font-extrabold text-white leading-tight mb-4">
            Enter the<br />
            Security <span style={{ color: "#38bdf8" }}>OTP Code</span>
          </h1>

          <p className="text-base mb-10" style={{ color: "#94a3b8" }}>
            We've sent a 6-digit verification code to your email. Please check your spam folder if it doesn't arrive within 2 minutes.
          </p>
      ...
      >
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          >
            <VerifyOtpForm onNavigate={onNavigate} email={email} />
          </div>
